      ...
      <section className="rounded-[20px] border border-white/8 bg-[#171a22] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.25)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-3 text-[34px] font-semibold leading-none tracking-[-0.04em] text-yellow-300">
      ...
      <section className="rounded-[20px] border border-white/8 bg-[#171a22] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.25)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-5 text-[34px] font-semibold leading-none tracking-[-0.04em] text-yellow-300">
              {upgrades}
            </div>
          </div>
