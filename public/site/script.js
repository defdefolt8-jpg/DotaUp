(() => {
  ...
  const items = [
    ...
    { id: 61, weapon: 'Axe', skin: 'Mantle of the Cinder Baron', wear: 'Immortal', price: 185, color: '#ff765f', shape: 'axe', imageLabel: 'Axe', imageAccent: '#ff765f', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/axe.png' },
    { id: 62, weapon: 'Axe', skin: 'Axe of Phractos', wear: 'Immortal', price: 7850, color: '#ffad57', shape: 'axe', imageLabel: 'Axe', imageAccent: '#ffad57', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/axe.png' },
    { id: 63, weapon: 'Sniper', skin: 'Muh Keen Gun', wear: 'Immortal', price: 690, color: '#72baff', shape: 'lance', imageLabel: 'Sniper', imageAccent: '#72baff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/sniper.png' },
    { id: 64, weapon: 'Sniper', skin: 'Full-Bore Bonanza', wear: 'Immortal', price: 420, color: '#6dd8ff', shape: 'lance', imageLabel: 'Sniper', imageAccent: '#6dd8ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/sniper.png' },
    { id: 65, weapon: 'Slark', skin: 'Sea Rake’s Bridle', wear: 'Immortal', price: 1180, color: '#5ed8e8', shape: 'daggers', imageLabel: 'Slark', imageAccent: '#5ed8e8', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/slark.png' },
    { id: 66, weapon: 'Slark', skin: 'Shadow in the Deep', wear: 'Immortal', price: 340, color: '#8272ff', shape: 'daggers', imageLabel: 'Slark', imageAccent: '#8272ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/slark.png' },
    { id: 67, weapon: 'Monkey King', skin: 'Staff of Gun-Yu', wear: 'Immortal', price: 730, color: '#ffc45b', shape: 'staff', imageLabel: 'MK', imageAccent: '#ffc45b', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/monkey_king.png' },
    { id: 68, weapon: 'Monkey King', skin: 'Golden Staff of Gun-Yu', wear: 'Immortal', price: 4250, color: '#ffd85d', shape: 'staff', imageLabel: 'MK', imageAccent: '#ffd85d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/monkey_king.png' },
    { id: 69, weapon: 'Sven', skin: 'Vigil Triumph', wear: 'Immortal', price: 2390, color: '#81a8ff', shape: 'blade', imageLabel: 'Sven', imageAccent: '#81a8ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/sven.png' },
    { id: 70, weapon: 'Sven', skin: 'Storm Hammer', wear: 'Immortal', price: 260, color: '#6da7ff', shape: 'hammer', imageLabel: 'Sven', imageAccent: '#6da7ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/sven.png' },
    { id: 71, weapon: 'Mars', skin: 'Spear of the Daemonfell Flame', wear: 'Immortal', price: 510, color: '#ff765d', shape: 'lance', imageLabel: 'Mars', imageAccent: '#ff765d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/mars.png' },
    { id: 72, weapon: 'Mars', skin: 'Molten Bore', wear: 'Immortal', price: 290, color: '#ff9b55', shape: 'shield', imageLabel: 'Mars', imageAccent: '#ff9b55', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/mars.png' },
    { id: 73, weapon: 'Luna', skin: 'Golden Moonfall', wear: 'Immortal', price: 3120, color: '#ffe16d', shape: 'blade', imageLabel: 'Luna', imageAccent: '#ffe16d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/luna.png' },
    { id: 74, weapon: 'Luna', skin: 'Moonfall', wear: 'Immortal', price: 610, color: '#8fb8ff', shape: 'blade', imageLabel: 'Luna', imageAccent: '#8fb8ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/luna.png' },
    { id: 75, weapon: 'Mirana', skin: 'Axia of Metira', wear: 'Immortal', price: 8450, color: '#8aa6ff', shape: 'bow', imageLabel: 'Mirana', imageAccent: '#8aa6ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/mirana.png' },
    { id: 76, weapon: 'Mirana', skin: 'Pulsar Remnant', wear: 'Immortal', price: 390, color: '#9d8dff', shape: 'bow', imageLabel: 'Mirana', imageAccent: '#9d8dff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/mirana.png' },
    { id: 77, weapon: 'Storm Spirit', skin: 'The Lightning Orchid', wear: 'Immortal', price: 560, color: '#68ceff', shape: 'staff', imageLabel: 'Storm', imageAccent: '#68ceff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/storm_spirit.png' },
    { id: 78, weapon: 'Ember Spirit', skin: 'Cinder Sensei', wear: 'Mythical', price: 980, color: '#ff7954', shape: 'daggers', imageLabel: 'Ember', imageAccent: '#ff7954', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/ember_spirit.png' },
    { id: 79, weapon: 'Void Spirit', skin: 'Hidden Vector', wear: 'Immortal', price: 640, color: '#ac78ff', shape: 'daggers', imageLabel: 'Void', imageAccent: '#ac78ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/void_spirit.png' },
    { id: 80, weapon: 'Templar Assassin', skin: 'Focal Resonance', wear: 'Immortal', price: 450, color: '#d27cff', shape: 'daggers', imageLabel: 'TA', imageAccent: '#d27cff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/templar_assassin.png' },
    { id: 81, weapon: 'Bounty Hunter', skin: 'Hunter’s Hoard', wear: 'Immortal', price: 330, color: '#ffc35f', shape: 'daggers', imageLabel: 'BH', imageAccent: '#ffc35f', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/bounty_hunter.png' },
    { id: 82, weapon: 'Bristleback', skin: 'Blastforge Exhaler', wear: 'Immortal', price: 240, color: '#ffb15f', shape: 'shield', imageLabel: 'BB', imageAccent: '#ffb15f', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/bristleback.png' },
    { id: 83, weapon: 'Disruptor', skin: 'Resistive Pinfold', wear: 'Immortal', price: 210, color: '#68c8ff', shape: 'staff', imageLabel: 'Disruptor', imageAccent: '#68c8ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/disruptor.png' },
    { id: 84, weapon: 'Necrophos', skin: 'Sullen Harvest', wear: 'Immortal', price: 840, color: '#6df2a0', shape: 'staff', imageLabel: 'Necro', imageAccent: '#6df2a0', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/necrolyte.png' },
    { id: 85, weapon: 'Lifestealer', skin: 'Golden Profane Union', wear: 'Immortal', price: 3680, color: '#ffd45d', shape: 'daggers', imageLabel: 'LS', imageAccent: '#ffd45d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/life_stealer.png' },
    { id: 86, weapon: 'Clinkz', skin: 'Maraxiform’s Ire', wear: 'Immortal', price: 470, color: '#ff8355', shape: 'bow', imageLabel: 'Clinkz', imageAccent: '#ff8355', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/clinkz.png' },
    { id: 87, weapon: 'Tusk', skin: 'Whisky the Stout Artifact', wear: 'Immortal', price: 300, color: '#77caff', shape: 'hammer', imageLabel: 'Tusk', imageAccent: '#77caff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/tusk.png' },
    { id: 88, weapon: 'Witch Doctor', skin: 'Bonkers the Mad', wear: 'Immortal', price: 720, color: '#9a72ff', shape: 'staff', imageLabel: 'WD', imageAccent: '#9a72ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/witch_doctor.png' },
    { id: 89, weapon: 'Enigma', skin: 'World Chasm Artifact', wear: 'Immortal', price: 1280, color: '#9375ff', shape: 'shield', imageLabel: 'Enigma', imageAccent: '#9375ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/enigma.png' },
    { id: 90, weapon: 'Kunkka', skin: 'Leviathan Whale Blade', wear: 'Immortal', price: 1760, color: '#68bde8', shape: 'blade', imageLabel: 'Kunkka', imageAccent: '#68bde8', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/kunkka.png' },
    { id: 91, weapon: 'Treasure', skin: 'Hallowed Chest of the Diretide', wear: 'Base', price: 3, color: '#6bbcff', shape: 'crown', imageLabel: 'Chest', imageAccent: '#6bbcff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/global/dota2_logo_symbol.png' },
    { id: 92, weapon: 'Treasure', skin: 'The Dead Reckoning Chest', wear: 'Base', price: 9, color: '#73caff', shape: 'shield', imageLabel: 'Chest', imageAccent: '#73caff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/global/dota2_logo_symbol.png' },
    { id: 93, weapon: 'Pudge', skin: 'Crazed Tassels', wear: 'Common', price: 14, color: '#b6becb', shape: 'hook', imageLabel: 'Pudge', imageAccent: '#b6becb', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/pudge.png' },
    { id: 94, weapon: 'Juggernaut', skin: 'Kataginu of the Crimson Ronin', wear: 'Uncommon', price: 28, color: '#74a7ff', shape: 'blade', imageLabel: 'Jugg', imageAccent: '#74a7ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/juggernaut.png' },
    { id: 95, weapon: 'Crystal Maiden', skin: 'Snowdrop Mantle', wear: 'Rare', price: 42, color: '#74d9ff', shape: 'staff', imageLabel: 'CM', imageAccent: '#74d9ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/crystal_maiden.png' },
    { id: 96, weapon: 'Invoker', skin: 'Shoulders of the Arsenal Magus', wear: 'Rare', price: 75, color: '#ac7cff', shape: 'wings', imageLabel: 'Invoker', imageAccent: '#ac7cff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/invoker.png' },
    { id: 97, weapon: 'Phantom Assassin', skin: 'Gothic Whisper Bracers', wear: 'Mythical', price: 125, color: '#826fff', shape: 'daggers', imageLabel: 'PA', imageAccent: '#826fff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/phantom_assassin.png' },
    { id: 98, weapon: 'Axe', skin: 'Blood Chaser', wear: 'Immortal', price: 195, color: '#ff705a', shape: 'axe', imageLabel: 'Axe', imageAccent: '#ff705a', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/axe.png' },
    { id: 99, weapon: 'Drow Ranger', skin: 'Bow of the Frostfangs', wear: 'Mythical', price: 275, color: '#73a9ff', shape: 'bow', imageLabel: 'Drow', imageAccent: '#73a9ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/drow_ranger.png' },
    { id: 100, weapon: 'Rubick', skin: 'Fantoccini Hat', wear: 'Immortal', price: 365, color: '#61f1c4', shape: 'crown', imageLabel: 'Rubick', imageAccent: '#61f1c4', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/rubick.png' },
    { id: 101, weapon: 'Lina', skin: 'Disciple of the Wyrmwrought Flame', wear: 'Mythical', price: 690, color: '#ff684d', shape: 'staff', imageLabel: 'Lina', imageAccent: '#ff684d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/lina.png' },
    { id: 102, weapon: 'Queen of Pain', skin: 'The Queen of Pain Arcana Bundle', wear: 'Arcana', price: 1350, color: '#d66dff', shape: 'wings', imageLabel: 'QoP', imageAccent: '#d66dff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/queenofpain.png' },
    { id: 103, weapon: 'Earthshaker', skin: 'Bracers of the Cavern Luminar', wear: 'Immortal', price: 2250, color: '#ffc359', shape: 'hammer', imageLabel: 'ES', imageAccent: '#ffc359', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/earthshaker.png' },
    { id: 104, weapon: 'Faceless Void', skin: 'Jewel of Aeons', wear: 'Immortal', price: 3750, color: '#9d7fff', shape: 'hammer', imageLabel: 'Void', imageAccent: '#9d7fff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/faceless_void.png' },
    { id: 105, weapon: 'Sniper', skin: 'The Magus Cypher Rifle', wear: 'Prestige', price: 5200, color: '#71bdff', shape: 'lance', imageLabel: 'Sniper', imageAccent: '#71bdff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/sniper.png' },
    { id: 106, weapon: 'Monkey King', skin: 'Great Sage’s Reckoning', wear: 'Arcana', price: 6800, color: '#ffc85e', shape: 'staff', imageLabel: 'MK', imageAccent: '#ffc85e', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/monkey_king.png' },
    { id: 107, weapon: 'Terrorblade', skin: 'Prismatic Fractal Horns', wear: 'Arcana', price: 8900, color: '#7deeff', shape: 'crown', imageLabel: 'TB', imageAccent: '#7deeff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/terrorblade.png' },
    { id: 108, weapon: 'Mirana', skin: 'Dark Moon Stalker', wear: 'Prestige', price: 11200, color: '#879eff', shape: 'bow', imageLabel: 'Mirana', imageAccent: '#879eff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/mirana.png' },
    { id: 109, weapon: 'Invoker', skin: 'Dark Artistry Set', wear: 'Mythical', price: 14800, color: '#aa71ff', shape: 'wings', imageLabel: 'Invoker', imageAccent: '#aa71ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/invoker.png' },
    { id: 110, weapon: 'Courier', skin: 'Unusual Golden Baby Roshan', wear: 'Courier', price: 18500, color: '#ffd45d', shape: 'wings', imageLabel: 'Roshan', imageAccent: '#ffd45d', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/global/dota2_logo_symbol.png' },
    { id: 111, weapon: 'Pudge', skin: 'Genuine Dragonclaw Hook', wear: 'Legendary', price: 24500, color: '#ff765b', shape: 'hook', imageLabel: 'Pudge', imageAccent: '#ff765b', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/pudge.png' },
    { id: 112, weapon: 'Axe', skin: 'Genuine Axe of Phractos', wear: 'Immortal', price: 29800, color: '#ffb251', shape: 'axe', imageLabel: 'Axe', imageAccent: '#ffb251', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/axe.png' },
    { id: 113, weapon: 'Faceless Void', skin: 'Genuine Mace of Aeons', wear: 'Immortal', price: 34600, color: '#a184ff', shape: 'hammer', imageLabel: 'Void', imageAccent: '#a184ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/faceless_void.png' },
    { id: 114, weapon: 'Courier', skin: 'Platinum Baby Roshan', wear: 'Courier', price: 39500, color: '#d7e9ff', shape: 'wings', imageLabel: 'Roshan', imageAccent: '#d7e9ff', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/global/dota2_logo_symbol.png' },
    { id: 115, weapon: 'Courier', skin: 'Legacy Ethereal Flames Wardog', wear: 'Legacy', price: 48500, color: '#ffcf67', shape: 'wings', imageLabel: 'Legacy', imageAccent: '#ffcf67', image: 'https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/global/dota2_logo_symbol.png' }
  ];
  ...
  $('#speedToggleButton').addEventListener('click', () => {
    ...
    state.spinDuration = fastEnabled ? 1000 : 5500;
    ...
    $('#speedToggleButton').title = fastEnabled ? 'Быстрая прокрутка: включена · 1 секунда' : 'Быстрая прокрутка: выключена · 5,5 секунды';
    showToast(fastEnabled ? 'Быстрая прокрутка · 1 секунда' : 'Обычная прокрутка · 5,5 секунды', 'success');
  });
